...
* Amazon Connect  - O Amazon Connect é um serviço de autoatendimento ao cliente. Uma especie de call center na nuvem.  

[Amazon Connect](https://aws.amazon.com/pt/connect)  


### Gerenciamento, monitoramento e governança:

* AWS Auto Scaling (escalabilidade, optimização de desempenho e custos)  
